...
<header id="header" class="header <?php echo( $theme_settings->style['bg']['bg_header_dark'] ? 'dark-mode' : ''); ?>">
	<div class="header__overflow js-nano js-nano-header">
		...
		<div class="nano-content">
            ...
            // DHLab logo
            echo '<div class="dhlab-logo">';
            echo '<object data="http://danteathand.yale.edu/wp-content/uploads/2016/10/dhlab-mark.svg" type="image/svg+xml">';
            echo '<img src="http://danteathand.yale.edu/wp-content/uploads/2016/10/dhlab.png" />';
            echo '</object>';
            echo '</div>';
